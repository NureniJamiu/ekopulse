...
// Component to handle map view updates from context
const MapViewController: React.FC = () => {
    ...
    useEffect(() => {
        if (leafletMap) {
            ...
            leafletMap.flyTo(center as LatLngExpression, zoom, {
    ...
    return (
        <div className="h-full w-full">
            ...
            >
                ...
                {/* Map view controller - handles center/zoom updates */}
                <MapViewController />
