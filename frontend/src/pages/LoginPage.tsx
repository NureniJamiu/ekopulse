...
import AgencyLoginModal from '../components/agency/AgencyLoginModal';
    ...
    <div className={`min-h-screen py-12 px-4 sm:px-6 lg:px-8 transition-all duration-500 ${
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="flex justify-center">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-gray-900">EcoPulse</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            {activeTab === 'citizen' ? (
              <div>
                {/* Citizen Benefits */}
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">As a Citizen, you can:</h3>
              ...
              <div>
                {/* Agency Benefits */}
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">As an Agency, you can:</h3>
                  <ul className="space-y-2">
                ...
                <p className="text-xs text-gray-500 text-center mt-4">
                  Agency accounts require verification and approval
                </p>
              </div>
            )}
          </div>
      ...
      <AgencyLoginModal
        ...
        onSuccess={() => {
          ...
          // Handle success - redirect is handled in the modal
        }}
      />
